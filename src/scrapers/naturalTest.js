...
input: The word we are looking for.
textInput: The .json file.
Returns: The string that has both the word we are looking for and a number. If it doesn't find any,
it returns null.
*/
...
/* Converts the due dates into Date format
input: The string we want to convert
textInput: The .json file.
Returns: N/A
*/
